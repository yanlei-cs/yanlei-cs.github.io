...
<UL style="LIST-STYLE-TYPE: none" class=pubs>
 <LI>Haoran Liu, Zhouyang Jia, Shanshan Li, <strong>Yan Lei</strong>, Yue Yu,Yu Jiang, Xiaoguang Mao, Xiangke Liao. Cut to the Chase: An Error-Oriented Approach to Detect Error-Handling Bugs. The ACM International Conference on the Foundations of Software Engineering (FSE), 2024, accepted. (CCF-A)</LI>	
